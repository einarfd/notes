...
from botnotes.web.admin import router as admin_router
from botnotes.web.routes import router as api_router
from botnotes.web.views import router as views_router
